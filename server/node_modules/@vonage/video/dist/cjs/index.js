...
__export(index_exports, {
  ...
  AudioRate: () => AudioRate,
  AudioTransportType: () => AudioTransportType,
...
var AudioRate = /* @__PURE__ */ ((AudioRate2) => {
  ...
  AudioRate2[AudioRate2["24KHZ"] = 24e3] = "24KHZ";
  return AudioRate2;
})(AudioRate || {});

// lib/enums/AudioTransportType.ts
var AudioTransportType = /* @__PURE__ */ ((AudioTransportType2) => {
  AudioTransportType2["BINARY"] = "binary";
  AudioTransportType2["JSON"] = "json";
  return AudioTransportType2;
})(AudioTransportType || {});
...
var ExperienceComposerResolution = ((ExperienceComposerResolution2) => {
  ExperienceComposerResolution2[ExperienceComposerResolution2["FHD_LANDSCAPE"] = "1920x1080" /* FHD_LANDSCAPE */] = "FHD_LANDSCAPE";
  ...
  async connectToWebsocket(sessionId, clientToken, config) {
    ...
    if (audioTransport) {
      websocket["audioTransport"] = {
        ...
        ...audioTransport["staticFields"] ? { "static_fields": audioTransport["staticFields"] } : {}
      };
    }
    const data = {
      sessionId,
