...
__export(index_exports, {
  ...
  AbstractEmailMessage: () => AbstractEmailMessage,
...
// lib/enums/Email/EmailContentTypes.ts
var EmailContentTypes = /* @__PURE__ */ ((EmailContentTypes2) => {
  EmailContentTypes2["TEXT"] = "text";
  EmailContentTypes2["HTML"] = "html";
  return EmailContentTypes2;
})(EmailContentTypes || {});

// lib/enums/Email/EmailImportance.ts
var EmailImportance = /* @__PURE__ */ ((EmailImportance2) => {
  EmailImportance2["HIGH"] = "High";
  EmailImportance2["NORMAL"] = "Normal";
  EmailImportance2["LOW"] = "Low";
  return EmailImportance2;
})(EmailImportance || {});

// lib/enums/Email/EmailPriority.ts
var EmailPriority = /* @__PURE__ */ ((EmailPriority2) => {
  EmailPriority2["NON_URGENT"] = "Non-Urgent";
  EmailPriority2["NORMAL"] = "Normal";
  EmailPriority2["URGENT"] = "Urgent";
  return EmailPriority2;
})(EmailPriority || {});

// lib/enums/Email/EmailSensitivity.ts
var EmailSensitivity = /* @__PURE__ */ ((EmailSensitivity2) => {
  EmailSensitivity2["PERSONAL"] = "Personal";
  EmailSensitivity2["PRIVATE"] = "Private";
  EmailSensitivity2["COMPANY_CONFIDENTIAL"] = "Company-Confidential";
  return EmailSensitivity2;
})(EmailSensitivity || {});
...
// lib/classes/Email/AbstractEmailMessage.ts
var AbstractEmailMessage = class extends AbstractMessage {
  /**
...
// lib/classes/Email/EmailContent.ts
var EmailContent = class extends AbstractEmailMessage {
...
// lib/classes/Email/EmailHTML.ts
var EmailHTML = class extends AbstractEmailMessage {
...
// lib/classes/Email/EmailText.ts
var EmailText = class extends AbstractEmailMessage {
  messageType = "text" /* TEXT */;
  /**
...
// lib/MessageRequestSerializer.ts
var import_server_client = require("@vonage/server-client");
var messageRequestSerializer = (params) => {
  const data = import_server_client.Client.transformers.snakeCaseObjectKeys(params, true);
...
var Messages = class extends import_server_client2.Client {
  /**
  ...
  async addAuthenticationToRequest(request) {
    ...
    this.authType = import_server_client2.AuthenticationType.BASIC;
    if (this.auth.applicationId && this.auth.privateKey) {
      log2("Adding JWT token to request");
      this.authType = import_server_client2.AuthenticationType.JWT;
    }
    if (this.auth.signature) {
      log2("Signing the request");
      this.authType = import_server_client2.AuthenticationType.SIGNATURE;
    }
